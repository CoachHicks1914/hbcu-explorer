...
const hbcuData = {
            ...
            "student-center": {
                ...
                content: `
                    ...
                    <ul>
                        ...
                        <li><strong>Keshia Knight Pulliam:</strong> Actress who played Rudy on "The Cosby Show"</li>
                    </ul>
                `,
                quiz: {
            ...
            "student-center": {
                ...
                content: `
                    ...
                    <ul>
                        ...
                        <li><strong>Keisha Lance Bottoms:</strong> Former Mayor of Atlanta and political leader</li>
        ...
        locations: {
            quad: {
                ...
                content: `
                    ...
                    <p>Clark Atlanta University is located in the Atlanta University Center, the largest consortium of HBCUs in the nation! CAU shares this historic neighborhood with Spelman, Morehouse, and the Morehouse School of Medicine.</p>
                    
                    <h3>Two Historic Schools Become One</h3>
                    <p>In 1988, Clark College (founded in 1869) and Atlanta University (founded in 1865) merged to create Clark Atlanta University. This brought together over 250 years of combined excellence in educating Black students!</p>
                    
                    <h3>The CAU Motto</h3>
                    <p>"Culture for Service" - CAU believes education should prepare students to serve and uplift their communities!</p>
                    
                    <h3>Panther Pride</h3>
                    <p>CAU students are Panthers - fierce, focused, and unstoppable! When Panthers graduate, they take their excellence everywhere they go!</p>
                `,
                quiz: {
                    question: "What is Clark Atlanta University's motto?",
                    options: [
                        "Culture for Service",
                        "Excellence Forever",
                        "Service Above Self",
            ...
            library: {
                ...
                content: `
                    ...
                    <p>Clark Atlanta offers a wide range of programs that prepare students for success in every field!</p>
                    
                    <h3>Top Programs</h3>
                    <ul>
                        <li><strong>Business:</strong> The School of Business Administration produces entrepreneurs, corporate leaders, and financial experts</li>
                        <li><strong>Mass Communications:</strong> Future journalists, TV producers, and media professionals start here</li>
                        <li><strong>Social Work:</strong> Training future counselors and community advocates</li>
                        <li><strong>Arts & Sciences:</strong> Chemistry, biology, psychology, and more!</li>
                    </ul>
                    
                    <h3>Graduate Programs</h3>
                    <p>CAU offers master's and doctoral programs, making it a place where students can go from freshman year all the way to earning a PhD!</p>
                    
                    <h3>Study Opportunities</h3>
                    <p>CAU students study abroad, conduct research, and work with professors on groundbreaking projects!</p>
                `,
                quiz: {
                    question: "When was Clark Atlanta University formed?",
                    options: [
                        "1865",
                        "1988",
                        "1995",
            ...
            stem: {
                ...
                content: `
                    ...
                    <h3>CAU STEM Stars</h3>
                    <ul>
                        <li><strong>NASA Partnership:</strong> CAU works with NASA on space research and sends students to work at NASA facilities</li>
                        <li><strong>Chemistry Powerhouse:</strong> CAU's chemistry program is nationally recognized</li>
                        <li><strong>Research Opportunities:</strong> Undergraduate students conduct real research in labs</li>
                    </ul>
                    
                    <h3>Health Sciences</h3>
                    <p>Many CAU graduates go on to medical school, dental school, and pharmacy school, becoming doctors and healthcare providers!</p>
                    
                    <h3>Technology Leaders</h3>
                    <p>CAU graduates work at major tech companies, bringing Black excellence to Silicon Valley and beyond!</p>
                `,
                quiz: {
                    question: "Which federal space agency does CAU partner with for research?",
                    options: [
                        "EPA",
                        "NASA",
                        "NOAA",
            ...
            "student-center": {
                ...
                content: `
                    <h3>Panther Pride</h3>
                    <p>CAU students carry themselves with confidence, excellence, and purpose. Once a Panther, always a Panther!</p>
                    
                    <h3>The AUC Connection</h3>
                    <p>Being part of the Atlanta University Center means CAU students can take classes and attend events at Spelman, Morehouse, and Morehouse School of Medicine. It's like having access to multiple campuses!</p>
                    
                    <h3>Greek Life & Organizations</h3>
                    <p>CAU is home to all nine historically Black fraternities and sororities (the Divine Nine), plus hundreds of other student organizations!</p>
                    
                    <h3>Famous Panthers</h3>
                    <ul>
                        <li><strong>Kenny Leon:</strong> Tony Award-winning Broadway director</li>
                        <li><strong>Jacque Reid:</strong> National TV journalist and host</li>
                        <li><strong>James Weldon Johnson:</strong> Writer of "Lift Every Voice and Sing" (the Black National Anthem)</li>
                        <li><strong>Numerous business executives:</strong> Leading major companies</li>
                    </ul>
                    
                    <h3>Atlanta Advantage</h3>
                    <p>Being in Atlanta means CAU students have access to internships at Fortune 500 companies, film studios, and major organizations!</p>
                `,
                quiz: {
                    question: "What is CAU's mascot?",
                    options: [
                        "The Lions",
                        "The Panthers",
                        "The Tigers",
    ...
    morrisBrown: {
        ...
        locations: {
            quad: {
                ...
                content: `
                    <h3>A College Built by the Community</h3>
                    <p>Morris Brown College is special because it was founded by Black people, for Black people! In 1881, members of the African Methodist Episcopal (AME) Church created Morris Brown to educate their children.</p>
                    
                    <h3>The Comeback Story</h3>
                    <p>Morris Brown faced hard times but is now rising again! The college is being rebuilt by alumni, students, and supporters who believe in its mission. This is a real-life lesson in resilience and never giving up!</p>
                    
                    <h3>The Morris Brown Spirit</h3>
                    ...
                    <p>The Wolverine is small but mighty - just like Morris Brown! Wolverines are fierce, determined, and never back down from a challenge.</p>
                `,
                quiz: {
                    question: "In what year was Morris Brown College founded?",
                    options: [
                        "1865",
                        "1881",
                        "1900",
            ...
            "student-center": {
                ...
                content: `
                    ...
                    <p>Morris Brown students are part of a comeback story! They're helping rebuild a historic institution and proving that HBCUs never die - they rise again!</p>
                    
                    <h3>The Famous Marching Band</h3>
                    <p>The Morris Brown Marching Wolverines were legendary! The band performed at major events and appeared in the movie "Drumline." The band is being rebuilt and will march again!</p>
                    
                    <h3>Greek Life Revival</h3>
                    <p>The Divine Nine fraternities and sororities are returning to Morris Brown's campus as the college rebuilds!</p>
                    
                    <h3>Famous Wolverines</h3>
                    <ul>
                        <li><strong>Hosea Williams:</strong> Civil rights leader who worked with Dr. Martin Luther King Jr.</li>
                        <li><strong>Anne Moody:</strong> Civil rights activist and author of "Coming of Age in Mississippi"</li>
                        <li><strong>Thousands of teachers:</strong> Who educated generations of Black children</li>
                    </ul>
                    
                    <h3>The Comeback Message</h3>
                    <p>Morris Brown teaches that setbacks don't define you - how you bounce back does! This is a lesson every student can carry for life.</p>
                `,
                quiz: {
                    question: "In which famous movie did the Morris Brown band appear?",
                    options: [
                        "Stomp the Yard",
                        "Drumline",
                        "School Daze",
    ...
    alabamaState: {
        ...
        locations: {
            quad: {
                title: "The ASU Campus",
                content: `
                    <h3>The Heart of Montgomery</h3>
                    <p>Alabama State sits in Montgomery, Alabama's capital city. Montgomery was the center of major Civil Rights Movement events, and ASU students were right there making history!</p>
                    
                    <h3>Founded to Educate Freed People</h3>
                    <p>Alabama State was founded in 1867 to educate formerly enslaved people. It started as a school for teachers and has grown into a full university with over 4,000 students!</p>
                    
                    <h3>The Hornet Spirit</h3>
                    <p>Hornets are small but powerful - when they work together, nothing can stop them! ASU students are the Mighty Hornets, working together to achieve greatness!</p>
                    
                    <h3>Civil Rights History</h3>
                    <p>ASU students participated in the Montgomery Bus Boycott and other civil rights protests. They risked everything for justice and equality!</p>
                `,
                quiz: {
                    question: "In which Alabama city is Alabama State University located?",
                    options: [
                        "Birmingham",
                        "Montgomery",
                        "Mobile",
            ...
            library: {
                ...
                content: `
                    ...
                    <p>Alabama State offers programs in business, education, health sciences, liberal arts, and STEM fields!</p>
                    
                    <h3>Top Programs</h3>
                    <ul>
                        <li><strong>Teacher Education:</strong> ASU was founded to train teachers and still produces excellent educators today</li>
                        <li><strong>Business:</strong> Future entrepreneurs and corporate leaders study here</li>
                        <li><strong>Nursing & Health Sciences:</strong> Training nurses and healthcare professionals</li>
                        <li><strong>Criminal Justice:</strong> Preparing students for careers in law enforcement and the legal system</li>
                    </ul>
                    
                    <h3>Graduate Programs</h3>
                    <p>ASU offers master's degrees and doctoral programs, allowing students to continue their education at the highest levels!</p>
                    
                    <h3>Hands-On Learning</h3>
                    <p>ASU students get real-world experience through internships in Montgomery's government offices, businesses, and organizations!</p>
                `,
                quiz: {
                    question: "What was Alabama State's original mission when founded?",
                    options: [
                        "Engineering school",
                        "Medical school",
                        "Teacher education",
            ...
            "student-center": {
                ...
                content: `
                    <h3>Black and Gold Pride</h3>
                    <p>Alabama State students wear their black and gold with pride! The Hornet family is tight-knit and supportive!</p>
                    
                    <h3>The Mighty Marching Hornets</h3>
                    <p>ASU's marching band, "The Mighty Marching Hornets," is one of the best HBCU bands in the nation! They perform at games, parades, and major events. The band's style is legendary!</p>
                    
                    <h3>The Magic City Classic</h3>
                    <p>Every year, ASU plays against Alabama A&M in Birmingham. The Magic City Classic is one of the biggest HBCU football games in America, with over 60,000 fans!</p>
                    
                    <h3>Famous Hornets</h3>
                    <ul>
                        <li><strong>Ralph Abernathy:</strong> Close friend and partner of Dr. Martin Luther King Jr. in the Civil Rights Movement</li>
                        <li><strong>JoAnn Robinson:</strong> Organized the Montgomery Bus Boycott</li>
                        <li><strong>Fred Gray:</strong> Legendary civil rights lawyer who represented Rosa Parks and Dr. King</li>
                        <li><strong>Thousands of teachers:</strong> Who educated Black children across the South</li>
                    </ul>
                    
                    <h3>Living History</h3>
                    <p>Being a student at ASU means walking where civil rights heroes walked and continuing their legacy of fighting for justice!</p>
                `,
                quiz: {
                    question: "What is Alabama State's annual football rivalry game called?",
                    options: [
                        "The Capital Classic",
